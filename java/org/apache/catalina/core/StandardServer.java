...
public final class StandardServer extends LifecycleMBeanBase implements Server {
	...
	/**
	 * A random number generator that is <strong>only</strong> used if the shutdown
	 * command string is longer than 1024 characters.
	 */
	...
	/**
	 * Wait until a proper shutdown command is received, then return. This keeps the
	 * main thread alive - the thread pool listening for http connections is daemon
	 * threads.
	 */
	@Override
	public void await() {
	...
	/**
	 * Write the configuration information for this entire <code>Server</code> out
	 * to the server.xml configuration file.
	 *
	 * @exception InstanceNotFoundException if the managed resource object cannot be
	 *                                      found
	 * @exception MBeanException            if the initializer of the object throws
	 *                                      an exception, or persistence is not
	 *                                      supported
	 * @exception                           javax.management.RuntimeOperationsException
	 *                                      if an exception is reported by the
