...
public final class Bootstrap {
	...
	/**
	 * Obtain the name of the configured base (instance) directory. Note that home
	 * and base may be the same (and are by default). If this is not set the value
	...
	/**
	 * Obtain the configured home (binary) directory. Note that home and base may be
	...
	/**
	 * Obtain the configured base (instance) directory. Note that home and base may
	 * be the same (and are by default). If this is not set the value returned by
	 * {@link #getCatalinaHomeFile()} will be used.
	 * 
