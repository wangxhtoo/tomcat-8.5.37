...
public abstract class AbstractProtocol<S> implements ProtocolHandler, MBeanRegistration {
	...
	/**
	 * Specifies whether the reason phrase will be sent in the response. By default
	 * a reason phrase will not be sent in the response.
	 *
	 * @deprecated This option will be removed in Tomcat 9. Reason phrase will not
	 *             be sent.
	 */
	@Deprecated
	...
	/**
	 * Returns whether the reason phrase will be sent in the response. By default a
	 * reason phrase will not be sent in the response.
	 *
	...
	protected static class ConnectionHandler<S> implements AbstractEndpoint.Handler<S> {
		...
		public SocketState process(SocketWrapperBase<S> wrapper, SocketEvent status) {
			...
			if (SocketEvent.TIMEOUT == status
					&& (processor == null || !processor.isAsync() || !processor.checkAsyncTimeoutGeneration())) {
